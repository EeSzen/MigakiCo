...
export default function BookingPage() {
  ...
  function validate(): boolean {
    ...
    if (!form.customerPhone.trim())
      next.customerPhone = "Enter your phone number.";
  ...
  async function handleSubmit() {
    ...
    if (junctionError) {
      setSubmitError(
        "Your booking was created but services couldn’t be attached. Contact us directly.",
      );
      setSubmitting(false);
      return;
    }
    ...
    <div className="min-h-screen bg-background px-4 py-10 flex justify-center text-foreground">
      <Card className="w-full max-w-md border-0 bg-transparent shadow-none">
        <CardContent className="p-0">
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      RM {service.price.toFixed(2)} &middot;{" "}
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              <div className="flex-1">
                ...
                {errors.date && (
                  <p className="text-xs text-[#D85A30] mt-1">{errors.date}</p>
                )}
              </div>
              <div className="flex-1">
                <Label className="mb-1 block text-xs text-muted-foreground">
                ...
                {errors.time && (
                  <p className="text-xs text-[#D85A30] mt-1">{errors.time}</p>
                )}
              </div>
            </div>
          ...
          {submitError && (
            <p className="text-sm text-[#D85A30] mt-4">{submitError}</p>
          )}
